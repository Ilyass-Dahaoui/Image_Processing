function filt = comparisonFiltHigh(figtest, D0)

figure, subplot(221), imshow(figtest), title('Image originale');
[M, N] = size(figtest);

gauss = 1 - lpfilter('gaussian', M, N, D0, 0); 
...
ideal = 1 - lpfilter('ideal', M, N, D0, 0); 
...
stitle = sprintf('Highpass ; D0 = %f', D0);
sgtitle(stitle)